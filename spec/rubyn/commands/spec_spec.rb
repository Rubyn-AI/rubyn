...
RSpec.describe Rubyn::Commands::Spec do
  ...
  before do
    ...
    stub_auth_verify
    stub_streaming_spec(content: "spec content")
  end
  ...
  describe "#execute" do
    it "calls the spec API" do
      command.execute(test_file)
      expect(WebMock).to have_requested(:post, "https://api.rubyn.dev/api/v1/ai/spec")
    end
